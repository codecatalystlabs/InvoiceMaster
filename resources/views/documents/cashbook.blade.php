...
<table class="header-table header-rule"><tr>
    ...
    <td style="width:42%;" class="title-block">
        <div class="cashbook-badge">CASH BOOK</div>
...
<table class="subheader-table"><tr>
    <td style="width:50%;"><span class="debit-label">DEBIT</span><span class="page-no">{{ $pageNo }}</span></td>
...
<table class="ledger">
    ...
    <tbody>
        <tr>{!! $debitCells !!}<td class="divider"></td>{!! $creditCells !!}</tr>
        @for($i = 0; $i < 17; $i++)
            <tr><td></td><td></td><td></td><td></td><td></td><td class="divider"></td><td></td><td></td><td></td><td></td><td></td></tr>
        @endfor
    </tbody>
</table>
</body>
