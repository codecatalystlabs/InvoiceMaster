...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('module:ledger')->get('/ledger', [LedgerController::class, 'index'])->name('ledger.index');
    Route::middleware('module:analytics')->get('/analytics', [AnalyticsController::class, 'index'])->name('analytics');
